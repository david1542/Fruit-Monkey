...
public class MonkeyAccessor implements TweenAccessor<Monkey>{
	    ...
	    @Override
	    public int getValues(Monkey target, int tweenType, float[] returnValues) {
	        switch (tweenType) {
	    ...
	    @Override
	    public void setValues(Monkey target, int tweenType, float[] newValues) {
	        switch (tweenType) {
